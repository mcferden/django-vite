...
class DjangoViteConfig(NamedTuple):
    ...
    # Origin for STATIC_URL.
    static_url_origin: str = ""
...
class DjangoViteAppClient:
    ...
    def __init__(
        ...
        self.static_url_origin = config.static_url_origin
    ...
    def _get_production_server_url(self, path: str) -> str:
        ...
        if apps.is_installed("django.contrib.staticfiles"):
            ...
            production_server_url = staticfiles_storage.url(production_server_url)

        if origin := self.static_url_origin:
            production_server_url = _replace_origin(production_server_url, origin)
...
class DjangoViteAssetLoader:
    ...
    LEGACY_DJANGO_VITE_SETTINGS: Dict[str, Optional[str]] = {
        ...
        "DJANGO_VITE_STATIC_URL_ORIGIN": "static_url_origin",
